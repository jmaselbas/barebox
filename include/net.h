...
//int net_tcp_recv(struct net_connection *con);
//int net_tcp_close(struct net_connection *con, timeout);
//int net_tcp_abort(struct net_connection *con);
//int net_tcp_status(struct net_connection *con);
